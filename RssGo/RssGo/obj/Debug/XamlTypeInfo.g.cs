...
namespace RssGo.XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_3_RssFeedItem() { return new RssGoLibrary.RssFeedItem(); }

        private object Activate_6_DateConverter() { return new RssGo.DateConverter(); }

        private object Activate_7_Settings() { return new RssGo.Settings(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "RssGoLibrary.RssFeedItem":
                userType = new XamlUserType(this, typeName, typeof(RssGoLibrary.RssFeedItem), GetXamlTypeByName("Object"));
                userType.Activator = Activate_3_RssFeedItem;
            ...
            case "RssGo.Settings":
                ...
                userType.AddMemberName("Foreground", "RssGo.Settings.Foreground");
                userType.AddMemberName("Background", "RssGo.Settings.Background");
                userType.AddMemberName("ApplicationName", "RssGo.Settings.ApplicationName");
                xamlType = userType;
                break;
        ...
        {
            var that = (RssGoLibrary.RssFeedItem)instance;
            that.Link = (System.String)Value;
        }
        private object get_6_Settings_Brush(object instance)
        {
            var that = (RssGo.Settings)instance;
            return that.Brush;
        }
        private object get_7_Settings_Foreground(object instance)
        {
            var that = (RssGo.Settings)instance;
            return that.Foreground;
        }
        private object get_8_Settings_Background(object instance)
        {
            var that = (RssGo.Settings)instance;
            return that.Background;
        }
        private object get_9_Settings_ApplicationName(object instance)
        {
            var that = (RssGo.Settings)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            case "RssGo.Settings.Brush":
                ...
                xamlMember.Getter = get_6_Settings_Brush;
                xamlMember.SetIsReadOnly();
                break;
            case "RssGo.Settings.Foreground":
                userType = (XamlUserType)GetXamlTypeByName("RssGo.Settings");
                xamlMember = new XamlMember(this, "Foreground", "Windows.UI.Xaml.Media.SolidColorBrush");
                xamlMember.Getter = get_7_Settings_Foreground;
                xamlMember.SetIsReadOnly();
                break;
            case "RssGo.Settings.Background":
                userType = (XamlUserType)GetXamlTypeByName("RssGo.Settings");
                xamlMember = new XamlMember(this, "Background", "Windows.UI.Xaml.Media.SolidColorBrush");
                xamlMember.Getter = get_8_Settings_Background;
                xamlMember.SetIsReadOnly();
                break;
            case "RssGo.Settings.ApplicationName":
                userType = (XamlUserType)GetXamlTypeByName("RssGo.Settings");
                xamlMember = new XamlMember(this, "ApplicationName", "String");
                xamlMember.Getter = get_9_Settings_ApplicationName;
                xamlMember.SetIsReadOnly();
                break;
